...
Каждый запуск создаёт отдельный файл `artifact_YYYYMMDD_HHMMSS.md` с: параметрами запуска, промптами, ответами, стоимостью токенов и сводной таблицей сравнения.
